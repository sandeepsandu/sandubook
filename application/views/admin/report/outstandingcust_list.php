 ...
 <section class="content">
   <div class="box">
    <div class="box-header">
      <h3 class="box-title">Outstanding Customer Report</h3>

    </div>

       <div>
           <?php echo form_open(base_url('report/outstandingcust/index'), 'class="form-horizontal"');  ?>
