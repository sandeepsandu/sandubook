      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/ledger/edit/'.$user['led_id']), 'class="form-horizontal"' )?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select name="ledgergpid" class="form-control">
                        ...
                        { ?><option value="<?php echo $each['ledger_groupid']; ?>"  <?php if($user['led_gpid']==$each['ledger_groupid']) echo 'selected="selected"'; ?>><?php echo $each['ledger_groupname']; ?></option>';
                        <?php }
                        ?>
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea class="form-control" v name="description" id="description" placeholder=""><?=$user['led_desc'];?></textarea>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="number" step=".01" name="amount"  value="<?=$user['led_amount'];?>" class="form-control" id="amount" placeholder="">
                </div>
            </div>
              ...
              <div class="form-group">
                <div class="col-md-11">
                  <input type="submit" name="submit" value="Update Ledger" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close(); ?>
          </div>
