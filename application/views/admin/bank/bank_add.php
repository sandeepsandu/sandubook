      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/bank/add'), 'class="form-horizontal"');  ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    { ?><option value="<?php echo $each['bank_groupid']; ?>"><?php echo $each['bank_groupname']; ?></option>';
                    <?php }
                    ?>
                    </select>
                </div>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <div class="col-md-11">
                  <input type="submit" name="submit" value="Add Bank" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          </div>
