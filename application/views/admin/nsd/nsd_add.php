      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/nsd/add'), 'class="form-horizontal"');  ?>
            ...
            <div class="form-group">
                ...
                <label for="firstname" class="col-sm-1 control-label">Customer</label>
...
<div class="form-group">
    ...
    <input type="text" name="datepicker" class="form-control" id="datepicker" placeholder="">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="number" step=".01" name="purrate" class="form-control" id="purrate" placeholder="">
                </div>

                <label for="mobile_no" class="col-sm-3 control-label">Purchase Amount</label>

                <div class="col-sm-2">
                    <input type="number" step=".01" name="puramount" readonly class="form-control" id="puramount" placeholder="">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="number" step=".01" name="salerate" class="form-control" id="salerate" placeholder="">
                </div>

                <label for="mobile_no" class="col-sm-3 control-label">Sale Amount</label>

                <div class="col-sm-2">
                    <input type="number" step=".01" name="saleamount" readonly class="form-control" id="saleamount" placeholder="">
                </div>
            </div>
              <div class="form-group">
                <div class="col-md-11">
                  <input type="submit" name="submit" value="Add NSD" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          </div>
