          ...
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    { ?><option value="<?php echo $each['suplr_groupid']; ?>"><?php echo $each['suplr_groupname']; ?></option>';
                    <?php }
                    ?>
                    </select>
                </div>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <div class="col-md-11">
                  <input type="submit" name="submit" value="Add Supplier" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          </div>
